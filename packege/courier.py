...
class Courier:
    ...
    def cancel(self,):
        self.__from.add(name=self.__request.product, quantity=self.__request.quantity)
        print(f'Курьер вернул {self.__request.quantity} {self.__request.product} из {self.__request.departure}')
